...
namespace CCRT_itemTags
{
    ...
    */
    public class SpecialThingFilterWorker_TagItemA : SpecialThingFilterWorker
    {
        ...
        {
            var taggedComp = t.TryGetComp<CompItemTags_CCRT>();
            if (taggedComp != null)
        ...
        {
            return def.HasComp(typeof(CompItemTags_CCRT));
        }
    }
    ...
    public class SpecialThingFilterWorker_NoTag : SpecialThingFilterWorker
    {
        public override bool Matches(Thing t)
        {
            ...
            if (taggedComp != null)
                ...
                */
                return !taggedComp.CCRT_TagItemA && !taggedComp.CCRT_TagItemB && !taggedComp.CCRT_TagItemC && !taggedComp.CCRT_TagItemD && !taggedComp.CCRT_TagItemE && !taggedComp.CCRT_TagItemF && !taggedComp.CCRT_TagItemG && !taggedComp.CCRT_TagItemH && !taggedComp.CCRT_TagItemI && !taggedComp.CCRT_TagItemJ && !taggedComp.CCRT_TagItemK && !taggedComp.CCRT_TagItemL;
            return true;
        }
